...
**The Noble**
![](/assets/img/noble.png#floatright)  
...
Day 7: News, Rumours and Events, if any, are announced.

**Proposals**: Any member can make a Proposal. The aim of Proposals is to earn Prestige for the player and to help the Party get closer to winning. Every proposal has consequences - both in terms of moving the fiction of the world forward and affecting the stats.
...
**Murderizing**: This is the Julius Caesar rule. High-prestige players are ripe targets for murderizing. To murderize a player, a character must gather a conspiracy of other characters (from any party) equal to the target’s Prestige (8 Prestige means 8 Players). Then, they must lure the target to a place where they are “alone” i.e. any channel where only conspirators and the target are actively present in the scene. Then, everyone involved in the murder has to post the :knife: emoji. (Once the first :knife: emoji has been posted, the target cannot leave the channel till it is clear if the murderizing failed or succeeded.)

 If enough people post the emoji, the target has a choice: they either die or retire into the woods. The player can make an entirely new character, including the child of their old character hankering for revenge. Every player involved in the murder loses 1 Prestige.

Note: Being "alone" might be a strange idea in a digital space but it can be implemented in a straightforward manner by making it explicit to the players that their character can only be active in one public channel and one private channel at a time. This gives them a certain physicality or spatial anchoring. They "leave" channels or spaces and "enter" others.

**Duels of Honour**: Duels of Honour are the more noble way of getting rid of opposing characters. If a character feels insulted or betrayed by another character, they can give them a glove. This is a warning. If the character feels insulted or betrayed for a second time, they throw their second glove at them. This means a Duel of Honour has been called. You can only challenge characters of higher Prestige than you. When a Duel is called, both parties must name a “second”. If either lose, their second can issue a follow-up Duel challenge to the winner. Nobody else can challenge the original winner or loser for the next 7 days.

 The two characters go to the Duelling Court and draw their weapons. The duel is resolved through dice. Each player rolls 4d6. After they roll, they count how many dice are either 4,5 or 6. Each such die counts as a Hit. The player with the lower number of Hits is considered to be losing. Ties are rerolled.

The losing player has a choice: lose gracefully or escalate. If they lose gracefully, they lose Prestige equal to the number of Hits scored by their opponent (but you cannot go below your starting Prestige). If they escalate, they get to choose to reroll any of their 4 dice, keeping the rest. After rerolling, they might still be losing or be winning. If they are still losing, they can again either lose gracefully or escalate again. If they are still losing after this, they have lost the fight. They must now decide if they die or fall back to their starting Prestige (based on their playset).
...
> Rattle (Prestige 5) challenges Bones (Prestige 10) to a duel. Rattle
> nominates Kell as their second, Bones nominates Zin.
> 
> In the first round, Rattle rolls 4d6 getting 5,4,3,1 which is 2 Hits.  Bones rolls 4d6 getting 1,1,1,6 which is 1 Hit. Bones could choose to lose gracefully and take -2 to Prestige putting them at 8. Or they can escalate. Bones decides that they aren’t going to lose and escalates!
> 
> Bones has 1 Hit (a 6) so they set that dice aside and reroll 3d6
> getting 2,2,4 which is 1 Hit, taking their total to 2 Hits. This is
> now a tie. But if you advance to a tie from losing, you are considered to be winning. So now Rattle has a choice: lose gracefully (-2 Prestige) or escalate! They choose to escalate!
> 
> Rattle keeps the 2 Hits (5,4) and rerolls 2d6 getting 3,3 which 0 new Hits. So it is still a tie but if you remain at a tie, you are still losing. Rattle is desperate and chooses to escalate again! They reroll d6 and get 4,6 which is 2 Hits. They now have 4 Hits. Now, Bones can lose gracefully and take -4 to Prestige, dropping them to 6 Prestige. Or they can escalate but if they are still losing after escalating, they will either die or go back down to starting Prestige which for them was 2. Ouch. Bones, filled with regret, chooses to lose gracefully. Rattle wins!
> 
...
**Rumours**: Game facilitators will post potentially true or false rumours to a Rumours channel, which will mostly be gossip about what happened in the private channels of various parties.
...
**Bring the world to life**: The world responds to the actions of the council in two forms: News, which are brief text updates, and Events, which involve NPCs with agendas and demands. The game facilitators decide how the world will respond to the events of the Parliament and how that response should manifest. Facilitators also post Rumours, which are true or false gossip about the characters in Parliament.
...
-   Party 1 (repeat for all parties)
...
### Appendix 2: Nation Template
 ...
 This assumes the nation is a constitutional monarchy - i.e. a parliament co-exists with a largely figurehead king or queen. Provide a few sentences of description at least and not just a name where appropriate. (Using something like Azgaar’s Fantasy Map Generator is a potential way of getting started on this process and gives you an interactive map to boot.)
...
Major Ancestries: (max 5)

  

Minor Ancestries: (Unlimited)
...
Nation’s Major Folk Epic:

Naton’s Minor Folk Epic:

What effect have these epics had on society?

  

Nation’s Major Religion:

Nation’s Minor Religion:

What values do these religions endorse?

  

**Major NPCs**

Chief Spymaster, who provides the News:

Vizier, who reports on the :

**Surrounding Nations**

(List 7 and describe them. Assign the following relationships among them: 1 Ally, 3 Enemy, 3 Undecided)


**Dangers**

(List dangerous outcomes that could occur when the nation's stats reach 1. One dangerous outcome for each of the stats: Military, Art, Industry, Religion, Diplomacy, Commerce.)
